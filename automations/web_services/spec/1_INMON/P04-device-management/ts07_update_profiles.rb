...
describe "TS07 - updateProfiles - #{Misc::CONST_ENV}" do
  ...
  context 'TC07.001 - updateProfiles - Successful Response' do
    device_serial1 = profile_name1 = slot1 = nil
    device_serial2 = profile_name2 = slot2 = nil

    before :all do
      # fetchDevice before updating profile
      xml_fetch_device_res1 = DeviceManagement.fetch_device(caller_id, device_serial, platform)
      device_serial1 = xml_fetch_device_res1.xpath('//device').attr('serial').text
      ...
      device_serial2 = xml_fetch_device_res2.xpath('//device').attr('serial').text
