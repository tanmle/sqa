...
=begin
ATG Content: Fill by Category and check app information on Catalog page
=end

describe "Category checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
