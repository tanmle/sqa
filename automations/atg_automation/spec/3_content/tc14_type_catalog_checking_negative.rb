...
=begin
ATG Content: Verify all apps that do not belong to the current Locale or Type shouldn't displayed
=end

describe "Type/Format Catalog Negative - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
