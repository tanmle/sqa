...
=begin
ATG Content: Fill by Type/Format and check app information on Catalog page
=end

describe "Type/Format catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
