...
=begin
ATG Content: Verify all apps that do not belong to current locale or current Age range shouldn't displayed
=end

describe "Age Catalog Negative - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
