...
=begin
ATG LeapPad Ultra Content: Verify all apps that do not belong to current locale or Age range or LPAD3 shouldn't displayed
=end

describe "LeapPad Ultra - Age negative checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
