...
=begin
Verify that user can check out with an existing account successfully
=end
...
feature "TC09 - Checkout - Checkout with existing account - ENV = '#{Data::ENV_CONST}' - Locale = '#{Data::LOCALE_CONST}'", js: true do
  ...
  context 'Ensure that user can check out with an existing account' do
