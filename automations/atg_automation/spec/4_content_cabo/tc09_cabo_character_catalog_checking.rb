...
=begin
ATG Cabo Content: Fill by Character and check app information on Catalog page
=end

describe "CABO - Character catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
