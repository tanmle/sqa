...
=begin
ATG Cabo Content: Fill by Skill and check app information on Catalog page
=end

describe "CABO - Skills catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
