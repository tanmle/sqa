...
=begin
ATG LFC Content: Verify all apps that do not belong to the current Locale or current Skill shouldn't displayed
=end

describe "LFC - Skill Catalog Negative checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
