...
=begin
ATG LFC Content: Verify all apps that is not belong to Category or Locale shouldn't displayed
=end

describe "LFC - Category Negative checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
