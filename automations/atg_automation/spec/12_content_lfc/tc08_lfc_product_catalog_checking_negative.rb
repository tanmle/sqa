...
=begin
ATG LFC Content: Verify all apps that do not belong to current locale or current Product shouldn't displayed
=end

describe "LFC - Product Catalog Negative - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
