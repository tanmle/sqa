...
=begin
ATG LFC Content: Fill by Product and check app information on Catalog page
=end

describe "LFC - Product catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
