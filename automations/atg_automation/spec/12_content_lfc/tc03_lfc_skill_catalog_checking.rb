...
=begin
ATG LFC Content: Fill by Skill and check app information on Catalog page
=end

describe "LFC - Skill catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
