...
=begin
ATG LFC Content: Fill by Category and check app information on Catalog page
=end

describe "LFC - Category checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
  ...
  category_list.each_hash do |category|
    ...
    titles = Connection.my_sql_connection(AppCenterContent::CONST_QUERY_CATEGORY_CATALOG_TITLE % [category_name, Title.map_content_type(category_name, 's2m')])
