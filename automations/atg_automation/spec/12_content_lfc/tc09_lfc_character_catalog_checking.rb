...
=begin
ATG LFC Content: Fill by Character and check app information on Catalog page
=end

describe "LFC - Character catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
