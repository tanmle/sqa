...
=begin
French ATG Cabo Content: Fill by Category and check app information on Catalog page
=end

describe "French/CABO - Category checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
