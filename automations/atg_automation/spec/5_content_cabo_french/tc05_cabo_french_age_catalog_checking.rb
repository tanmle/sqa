...
=begin
French ATG Cabo Content: Fill by Age and check app information on Catalog page
=end

describe "French/CABO - Age catalog checking - Env: #{Data::ENV_CONST} - Locale: #{Data::LOCALE_CONST.upcase}" do
