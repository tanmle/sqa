class Sqaauto564DashboardUpdateLeaptvToLeaptvRegister < ActiveRecord::Migration
  def up
    @connection = ActiveRecord::Base.connection
    say "SQAAUTO-564 Dashboard - Update 'LeapTV' to 'LeapTV Register'"

    say "Dashboard - Update 'LeapTV' to 'LeapTV Register'"
    services_json = '
      {
        "services":[
          {
    ...
    @connection.execute "UPDATE env_versions SET services = '#{services_json}' WHERE id = 1"
  end
end
